...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Beacon beacon = new Beacon.Builder()
                ...
                .setId2("1")
                .setId3("2")
                .setManufacturer(0x0075) // Samsung Networks.  Change this for other beacon layouts
                .setTxPower(-59)
        ...
        System.out.println("Just before start advertising");
        beaconTransmitter.startAdvertising(beacon, new AdvertiseCallback() {
            ...
            public void onStartSuccess(AdvertiseSettings settingsInEffect) {
                ...
                System.out.println("Beacon " + beacon.toString() + " Beacon id " + beaconTransmitter.toString());
            }
        });
        // ATTENTION: This was auto-generated to implement the App Indexing API.
        // See https://g.co/AppIndexing/AndroidStudio for more information.
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.jinna.beacontransmitter/http/host/path")
        );
